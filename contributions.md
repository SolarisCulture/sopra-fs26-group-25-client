...
|                    | [14.04.2026 --> worked ahead for week 3]   | [] | [Task: Add a input field for the hint and the number of cards #91, Task: Add a button that sends the content of the input fields to the server #92, Task: Receive the history from the backend and display it #93] | [This contribution is relevant, because now a spymaster can publish hints and they get saved in the history - both crucial aspects of the game.] |
